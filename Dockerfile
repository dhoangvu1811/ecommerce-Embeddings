...
# Includes: local sentence-transformers text embeddings + CLIP image search (torch CPU-only)
# =============================================================================
...
# Install production dependencies (torch CPU-only + CLIP + sentence-transformers)
